  ...
  var wrapper = function (_React$Component) {
    ...
    createClass(RTFixedDraggableColumn, [{
              ...
              if (mode === DragMode.REORDER) {
                ...
                if (allowDrop) {
                  ...
                  if (onDropSuccess) {
                    ...
                    onDropSuccess(_this2.currentColumnOrder[_this2.dragged], _this2.currentColumnOrder[dropIndex], _this2.dragged, dropIndex, oldOffset, newOffset);
                  }
      ...
      value: function render() {
        ...
        var previousOrder = [].concat(toConsumableArray(this.currentColumnOrder));
        ...
        if (!this.state.firstLoad) {
          var originalOrder = previousOrder.map(function (col) {
